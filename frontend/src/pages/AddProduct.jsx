        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div className="flex items-end gap-2">
            ...
            <div className="flex-1">
              ...
              <label className="block text-sm font-medium mb-1">Εταρεία</label>
          ...
          <div>
            ...
            <label className="block text-sm font-medium mb-1">Κοινό</label>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <label className="mt-2 inline-flex items-center gap-2 text-sm text-slate-700">
              ...
              Επισημαίνει ότι είναι στοck item (εμφανίζεται στην λίστα Stock)
          ...
          <div>
            ...
            <label className="block text-sm font-medium mb-1">Όριο Επανάληψης</label>
